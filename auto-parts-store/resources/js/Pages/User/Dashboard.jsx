...
export default function Dashboard({ auth, userCars, vinRequests }) {
    ...
    const getVinRequestStatusText = (status) => {
        const statusMap = {
            'new': 'Новый',
    ...
    const getVinRequestStatusClass = (status) => {
        const statusClasses = {
                ...
                <div className="max-w-8xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div className="p-6 text-gray-900">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
                                    ...
                                    <Link href={route('orders.index')} className="text-xl font-bold text-indigo-700 hover:text-indigo-900">
                                        Мои заказы
                                    </Link>
                                </div>
                                ...
                                <div className="bg-emerald-50 p-6 rounded-lg border border-emerald-100">
                                    ...
                                    <Link href={route('cart')} className="text-xl font-bold text-emerald-700 hover:text-emerald-900">
                                        Перейти в корзину
                                    </Link>
                                </div>
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                        <div className="p-6 text-gray-900">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Link href={route('vin-request.index')} className="text-green-600 hover:text-green-800 text-sm font-medium">
                                    Мои VIN-запросы
                                </Link>
                            </div>
                                            ...
                                            {vinRequests.map((request) => (
                                                <tr key={request.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getVinRequestStatusClass(request.status)}`}>
                                                            {getVinRequestStatusText(request.status)}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <Link
                                                            href={route(`vin-request.show`, { id: request.id })}
                    ...
                    <div className="mt-4 border rounded-lg shadow-sm bg-white p-4">
                        ...
                        <div className="space-y-2">
                            <Link href="/profile" className="text-indigo-600 hover:text-indigo-900 block">
