...
const EditCategory = () => {
  const { errors, category, categories } = usePage().props;
  ...
  // Фильтруем список категорий, чтобы исключить текущую категорию и её потомков
  ...
  const handleSubmit = (e) => {
    ...
    Inertia.post(route('categories.update', category.id), values, {
      forceFormData: true
    });
  };
  ...
  return (
    <div className="container">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h1 className={styles.sectionTitle}>Редактирование категории</h1>
